...
const RestuarantSchema = new mongoose_1.default.Schema({
    name: {
        type: String,
...
module.exports = mongoose_1.default.model('Restuarant', RestuarantSchema);
//# sourceMappingURL=Restuarant.js.map